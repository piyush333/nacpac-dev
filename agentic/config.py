...
DISCORD_NACPAC_BUILDS_CHANNEL_ID = int(os.getenv("DISCORD_NACPAC_BUILDS_CHANNEL_ID", "0"))
DISCORD_NACPAC_DEPLOYS_CHANNEL_ID = int(os.getenv("DISCORD_NACPAC_DEPLOYS_CHANNEL_ID", "0"))
DISCORD_JICO_BUILDS_CHANNEL_ID = int(os.getenv("DISCORD_JICO_BUILDS_CHANNEL_ID", "0"))
DISCORD_JICO_DEPLOYS_CHANNEL_ID = int(os.getenv("DISCORD_JICO_DEPLOYS_CHANNEL_ID", "0"))
